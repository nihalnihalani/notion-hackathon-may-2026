...
/**
 * Sheet — side panel built on Radix Dialog. We use it for the mobile sidebar
 * (slides in from the left on small screens) and could be used for any
 * additional inspector panels later.
 */
