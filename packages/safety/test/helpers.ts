...
export const TEST_OPTS: ScanOptions = {
  ...
  depAllowlist: ['@notionhq/client', '@notion/workers-sdk', '@forge/connectors', 'zod', 'date-fns'],
};
...
export function runRule(rule: Rule, source: string, opts: ScanOptions = TEST_OPTS): Violation[] {
