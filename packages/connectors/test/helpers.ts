/**
 * Test helpers — mock fetch builders + assertion utilities.
 */
...
/**
 * Build a mock fetch that returns the supplied responses in order.
 * After the supplied responses are exhausted, the LAST response is reused
 * (useful for retry-storm tests where every attempt should see the same 5xx).
 */
